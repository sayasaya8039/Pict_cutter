...
- **Edit/Write/Bash/ビルド/プッシュ/プル時にエラーが発生した場合、そのエラーを記憶すること**
- **同じエラーを繰り返さないよう、学習した対処法を次回以降に適用すること**
- エラー発生時は原因と対策をCLAUDE.mdの「トラブルシューティング」セクションに追記
